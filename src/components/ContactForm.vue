...
export default {
    ...
    data() {
        const contactFormSchema = yup.object().shape({
            name: yup.string().required("Tên phải có giá trị.").min(2, "Tên phải ít nhất 2 ký tự.").max(50, "Tên có tối đa 50 ký tự."),
            email: yup.string().email("E-mail không đúng định dạng.").max(50, "E-mail tối đa 50 ký tự."),
    ...
    methods: {
        ...
        values.favorite = this.contactLocal.favorite;
